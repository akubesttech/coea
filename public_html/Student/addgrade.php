...
//if($grade_group == "01"){ 
	mysqli_query($condb,"insert into grade_tb(prog,grade_group,b_min,b_max,grade,gradename,gp)values('".safee($condb,$f_pro)."','".safee($condb,$grade_group)."','".safee($condb,$min_grade)."','".safee($condb,$max_grade)."','".safee($condb,$grade)."','".safee($condb,$graderemark)."','".safee($condb,$gradepoint)."')") or die(mysqli_error($condb));//}else{
...
<input type="text"  id="max" name="max" value="" placeholder="0" onkeypress="return isNumber(event);"   class="form-control" >
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback" id="grade" style="display: none;" >
                	...
                	<div class="form-group"><select   class="form-control" name="grade"  ><option selected="selected" value="" >Select Grade</option><option  value="A">A</option><option  value="B">B</option><option  value="C">C</option><option  value="D">D</option><option  value="E">E</option><option  value="F">F</option>
</select></div>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback" id="gpoint" style="display: none;">
                	...
                	<div class="form-group">
                	 <input type="text" class="form-control "   name='gpoint' id="gpoint"  placeholder="0" >
			    					</div>
