...
<tr ><td height="32" colspan="2" style="font-size:22px;font-weight: bold;color: blue; font-family:vandana;text-shadow: 1px 1px gray;"> <div class="rounded" align="center"><br><br>
 <div style="font-size:18px; color:black;"> Transaction Reference:<?php echo  " ".$rsprint1['trans_id']; ?></div><br>
...
<div class="rounded">
 ...
 ?>
          ...
          <td height="36" colspan="4" style="color: #000080; font-size:20px;  font-family:  vandana;text-shadow: 1px 1px gray;"><strong>Payment Details:</strong><hr style="border-top: 1px solid black; background: transparent;"></td></tr>
  </table>
