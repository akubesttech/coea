...
<!--<div class="container">
  <div class="row-fluid">
      <div class="col-lg-12">
            <div class="alert alert-success alert-dismissable">
             ...
             <i class="icon-check"></i><strong> List of Student (s)</strong>
            </div>
       </div>
    </div>
  </div> --!>
 ...
 <div class="block">
<div class="row-fluid">
<?php  $depart = $_GET['dep'];$session=$_GET['sec']; $c_choice= $_GET['ccho']; $categ= $_GET['p1'];
if($categ == "2"){ $cone = "First Choice"; $ntwo = "JAMB Score"; $utmes = "Post UTME Score"; $avescore = "Average Score";
if($c_choice == "1"){ 
$viewapplist = mysqli_query($condb,"select * from new_apply1 where reg_status = '1' and Asession = '".safee($condb,$session)."' and app_type = '".safee($condb,$class_ID)."' and first_Choice ='".safee($condb,$depart)."' and adminstatus = '1' and course_choice = '1' order by stud_id DESC ")or die(mysqli_error($condb));}else{
$viewapplist = mysqli_query($condb,"select * from new_apply1 where reg_status = '1' and Asession = '".safee($condb,$session)."' and app_type = '".safee($condb,$class_ID)."' and Second_Choice ='".safee($condb,$depart)."' and adminstatus = '1' and course_choice = '2' order by stud_id DESC")or die(mysqli_error($condb));
}}else{   $cone = "First Choice";$ntwo = "Second Choice";$utmes = "UTME Score"; $avescore = "Post UTME Score"; if($c_choice == "1"){ 
$viewapplist = mysqli_query($condb,"select * from new_apply1 where reg_status = '1' and Asession = '".safee($condb,$session)."' and app_type = '".safee($condb,$class_ID)."' and first_Choice ='".safee($condb,$depart)."' order by stud_id DESC ")or die(mysqli_error($condb));}else{
$viewapplist = mysqli_query($condb,"select * from new_apply1 where reg_status = '1' and Asession = '".safee($condb,$session)."' and app_type = '".safee($condb,$class_ID)."' and Second_Choice ='".safee($condb,$depart)."' order by stud_id DESC ")or die(mysqli_error($condb)); }}
if($c_choice == "1"){ $nchoice = "First Choice";}else{$nchoice = "Second Choice";}
...
//}
		$num_rows2 =mysqli_num_rows($viewapplist);
			if($num_rows2 < 1){ message("The page you are trying to access is not Available.", "error");
redirect('new_apply.php?view=sech_r'); }
//$row2 = mysqli_fetch_array($viewapplist);
...
font-family:"Times New Roman","serif";color:green;'><?php if($categ == "2"){ echo getdeptc($depart)." <br>".$nchoice."  Admitted Student(s) for ".$session." Session."; }else{echo getdeptc($depart)." <br>".$nchoice."  Application for ".$session." Session.";    } ?></span></u></b></p>
...
//if($_SESSION['los']==Null){echo "All Students ". $valuecheck .getdeptc($departmen);}else{echo "All ".getlevel($_SESSION['los'],$class_ID)." Level Students ".$valuecheck.getdeptc($departmen);}  ?><o:p></o:p></span></p>
...
<div class="pull-right">
   <div class="empty" id="ccc2">
		   ...
		   <script type="text/javascript">
            ...
            normal'><span style='font-size:12.0pt;mso-bidi-font-size:11.0pt;font-family:
           "Times New Roman","serif"'>
			<a id="return" data-placement="top" class="btn btn-success" title="Click to Return" onclick="window.open('new_apply.php?view=sech_r','_self')"><i class="icon-arrow-left"></i> Back</a></p>		
			<script type="text/javascript">
			$(document).ready(function(){
			$('#return').tooltip('show');
			$('#return').tooltip('hide');
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;height:23.25pt'>
  ...
  mso-background-themeshade:191;padding:0in 5.4pt 0in 5.4pt;height:23.25pt'>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><b style='mso-bidi-font-weight:normal'><span style='font-family:"Times New Roman","serif"'>Application No<o:p></o:p></span></b></p>
  </td>
  ...
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><b style='mso-bidi-font-weight:normal'><span style='font-family:"Times New Roman","serif"'>Name (Surname First)<o:p></o:p></span></b></p>
  </td>
  <td width=188 style='width:140.9pt;border:solid windowtext 1.0pt;border-left:
  none;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  background:#BFBFBF;mso-background-themecolor:background1;mso-background-themeshade:
  ...
  191;padding:0in 5.4pt 0in 5.4pt;height:23.25pt'>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><b style='mso-bidi-font-weight:normal'><span style='font-family:"Times New Roman","serif"'>Date of Reg<o:p></o:p></span></b></p>
  </td>
  <!-- <td width=188 style='width:140.95pt;border:solid windowtext 1.0pt;border-left:
  none;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  background:#BFBFBF;mso-background-themecolor:background1;mso-background-themeshade:
  191;padding:0in 5.4pt 0in 5.4pt;height:23.25pt'>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><b style='mso-bidi-font-weight:normal'><span style='font-family:"Times New Roman","serif"'>Department<o:p></o:p></span></b></p>
  </td>--!>
   <td width=188 style='width:140.95pt;border:solid windowtext 1.0pt;border-left:
  none;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  background:#BFBFBF;mso-background-themecolor:background1;mso-background-themeshade:
  191;padding:0in 5.4pt 0in 5.4pt;height:23.25pt'>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:normal'><b style='mso-bidi-font-weight:normal'><span style='font-family:"Times New Roman","serif"'> <?php if($categ > 1){echo $SGdept1;}else{ echo $cone; } ?><o:p></o:p></span></b></p>
  </td>  
   <td width=188 style='width:140.95pt;border:solid windowtext 1.0pt;border-left:
  none;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  background:#BFBFBF;mso-background-themecolor:background1;mso-background-themeshade:
  191;padding:0in 5.4pt 0in 5.4pt;height:23.25pt'>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><b style='mso-bidi-font-weight:normal'><span style='font-family:"Times New Roman","serif";'><?php echo $ntwo ;  ?><o:p></o:p></span></b></p>
  </td>
   <td width=188 style='width:140.95pt;border:solid windowtext 1.0pt;border-left:
  none;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  background:#BFBFBF;mso-background-themecolor:background1;mso-background-themeshade:
  191;padding:0in 5.4pt 0in 5.4pt;height:23.25pt'>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><b style='mso-bidi-font-weight:normal'><span style='font-family:"Times New Roman","serif";'><?php echo $utmes ;  ?><o:p></o:p></span></b></p>
  </td>
   <td width=188 style='width:140.95pt;border:solid windowtext 1.0pt;border-left:
  none;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  background:#BFBFBF;mso-background-themecolor:background1;mso-background-themeshade:
  191;padding:0in 5.4pt 0in 5.4pt;height:23.25pt'>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><b style='mso-bidi-font-weight:normal'><span style='font-family:"Times New Roman","serif"'><?php echo $avescore ;  ?><o:p></o:p></span></b></p>
  </td>
   <td width=188 style='width:140.95pt;border:solid windowtext 1.0pt;border-left:
  none;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  background:#BFBFBF;mso-background-themecolor:background1;mso-background-themeshade:
  191;padding:0in 5.4pt 0in 5.4pt;height:23.25pt'>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><b style='mso-bidi-font-weight:normal'><span style='font-family:"Times New Roman","serif"'>Admission Status<o:p></o:p></span></b></p>
  </td>
 </tr>
   <!-- MYSQL FETCH ARRAY-->
<?php

$num_rows =mysqli_num_rows($viewapplist);
		$serial=1;
		while($row = mysqli_fetch_array($viewapplist)){$chot = $row['course_choice'];
if($categ == "2"){  $pscore1 = $row['post_uscore']; $avescore = $row['average_score'];}else{ $pscore1 = $row['J_score']; $avescore = $row['post_uscore'];} if($chot > 1){   $admittedc = $row['Second_Choice'];   }else{ $admittedc = $row['first_Choice'];   }
?>
 ...
 <td width=10 valign=top style='width:30.95pt;border-top:none;border-left:
  ...
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><span style='font-family:"Times New Roman","serif"'><?php echo $row['appNo']; ?><o:p></o:p></span></p>
  </td>
  ...
  mso-border-alt:solid windowtext .5pt;padding:0in 5.4pt 0in 5.4pt'>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><span style='font-family:"Times New Roman","serif"'><?php echo $row['FirstName']." ".$row['SecondName']." ".$row['Othername']; ?><o:p></o:p></span></p>
  </td>
  <td width=188 valign=top style='width:140.9pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0in 5.4pt 0in 5.4pt'>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><span style='font-family:"Times New Roman","serif"'><?php echo $row['phone']; ?><o:p></o:p></span></p>
  </td>
  ...
  mso-border-alt:solid windowtext .5pt;padding:0in 5.4pt 0in 5.4pt'>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><span style='font-family:"Times New Roman","serif"'><?php echo $row['dateofreg']; ?><o:p></o:p></span></p>
  </td>
  </td>
<!--  <td width=188 valign=top style='width:140.95pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0in 5.4pt 0in 5.4pt'>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:normal'><span style='font-family:"Times New Roman","serif";color:
  <?php echo ($depart == $admittedc)?"green":"black" ; ?>'><?php echo getdeptc($admittedc); ?><o:p></o:p></span></p>
  </td>
  <td width=188 valign=top style='width:140.95pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0in 5.4pt 0in 5.4pt'>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><span style='font-family:"Times New Roman","serif";'><?php echo $row['J_score']; ?><o:p></o:p></span></p>
  </td><?php }else{ ?>
  <td width=188 valign=top style='width:140.95pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0in 5.4pt 0in 5.4pt'>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><span style='font-family:"Times New Roman","serif";color:<?php echo ($depart == $row['first_Choice'])?"green":"black" ; ?>'><?php echo getdeptc($row['first_Choice']); ?><o:p></o:p></span></p>
  </td>
  <td width=188 valign=top style='width:140.95pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0in 5.4pt 0in 5.4pt'>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><span style='font-family:"Times New Roman","serif";color:<?php echo ($depart == $row['Second_Choice'])?"green":"black" ; ?>'><?php echo getdeptc($row['Second_Choice']); ?><o:p></o:p></span></p>
  </td>
 <?php } ?>
  <td width=188 valign=top style='width:140.95pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0in 5.4pt 0in 5.4pt'>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><span style='font-family:"Times New Roman","serif";'><?php echo $pscore1; ?><o:p></o:p></span></p>
  </td>
  </td>
  <td width=188 valign=top style='width:140.95pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0in 5.4pt 0in 5.4pt'>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><span style='font-family:"Times New Roman","serif"'><?php echo $avescore; ?><o:p></o:p></span></p>
  </td>
  </td>
  <td width=188 valign=top style='width:140.95pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0in 5.4pt 0in 5.4pt'>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><span style='font-family:"Times New Roman","serif"'><?php echo getappstatus($row['adminstatus']); ?><o:p></o:p></span></p>
  </td>
 ...
 <tr style='mso-yfti-irow:2;mso-yfti-lastrow:yes'>
  ...
  <?php if($categ > 1){echo "<h4>Total Number Of Admitted Student(s) is ".numtowords($num_rows).".</h4> <P>";}else{ echo "<h4>Total Number Of Applicant record(s) Generated is ".numtowords($num_rows).".</h4> <P>"; }  ?>
  <o:p></o:p></span></p>
  </td>
 </tr>
</table>
...
?>
 ...
 <tr style='mso-yfti-irow:2;mso-yfti-lastrow:yes'>
  ...
  <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><span style='font-size:12.0pt;
  mso-bidi-font-size:11.0pt;font-family:"Times New Roman","serif"'>School Registrar<o:p></o:p></span></p>
  </td>
  <td width=376 valign=top style='width:281.85pt;padding:0in 5.4pt 0in 5.4pt'>
  <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><span style='font-size:12.0pt;
