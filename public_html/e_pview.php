...
if($dform_checkexist2 < 1){ message("Payment not completed please try Again!.", "error");
...
<div class="container">
    <div class="row">
        <div class="col-xs-12 col-md-9 link-icons">
            <div class="row">
                <div class="col-xs-12">
            <h3>Payment Information Preview </h3>
        </div>
        <div class="col-xs-12 primary-content link-icons">
<p class="first-paragraph"><font color="red">Please Note That a debit card will be required at this stage to complete your payment.<br>
           ...
           <div class="col-xs-12">
        	...
        	<div class="panel panel-default">
        		<div class="panel-heading">
			    		 <h4 class="panel-title"><small>Payment Reference </small> ( <?php echo $ftranid; ?> ) </h4>
  ...
  <td width="20%" colspan="2" height="20"><strong> </strong></td>
    ...
    <td width="20%" colspan="1" style="text-shadow: 1px 0px #0000FF; text-decoration-style: solid; font-weight: bold;">&#8358; <?php echo " ".number_format($tpayamt,2); //$_SESSION['mobile']; ?></td>
		...
		<tr style="border-width: 0px;text-align:left;padding-top: 20px;">
          <td height="10" colspan="1"><button name="Login_Reprint" class="btn btn-success" data-placement="right" type="button" title="Click to Download Payment Slip">Download Payment Slip</button></td>
            <td height="10" colspan="1">&nbsp;<button name="Login_Reprint" class="btn btn-primary" data-placement="right" type="submit" title="Click to Make Payment">Pay Now</button></td>
